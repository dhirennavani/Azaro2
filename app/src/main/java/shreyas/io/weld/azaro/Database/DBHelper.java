...
public class DBHelper  extends SQLiteOpenHelper {
    ...
    public long addNewCourse(Course newCourse) {
        ...
        Log.d("addNewCourse", "addNewCourse: weekday"+newCourse.getWeekDay());
        // insert row
    ...
    public List<Course> getAllCourses(){
        ...
        if (resultCourseValues.moveToFirst()) {
            do {
                ...
                //outputResult.setWeekDay(resultCourseValues.getInt(resultCourseValues.getColumnIndex(DBRelatedConstants.COURSE_WEEKDAY)));
